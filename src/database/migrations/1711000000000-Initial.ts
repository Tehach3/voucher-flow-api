...
export class Initial1711000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_eventos_estado"             ON "eventos" ("estado")`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_participantes_activo"         ON "participantes" ("activo")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_participantes_fecha_registro"  ON "participantes" ("fecha_registro" DESC)`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_participaciones_participante_id" ON "participaciones_evento" ("participante_id")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_participaciones_evento_id"       ON "participaciones_evento" ("evento_id")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_participaciones_activo"          ON "participaciones_evento" ("activo")`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_evento_id"        ON "tickets" ("evento_id")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_participacion_id" ON "tickets" ("participacion_id")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_sku"              ON "tickets" ("sku")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_fecha_carga"      ON "tickets" ("fecha_carga" DESC)`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_activo"           ON "tickets" ("activo")`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_pendientes_estado"         ON "tickets_pendientes" ("estado")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_tickets_pendientes_fecha_registro" ON "tickets_pendientes" ("fecha_registro" DESC)`);
